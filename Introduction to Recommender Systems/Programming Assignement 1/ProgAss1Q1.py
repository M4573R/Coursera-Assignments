#Title: Python script for computing answer to Question 1 of Programming Assignment 1 (Intro to Recommender Systems)
#Author: Karan J. Thakkar
#Question: Basic formula
#Output: Provides the top 5 movie ID's
#Usage: python ProgAss1Q1.py movie1 movie2 movie3
